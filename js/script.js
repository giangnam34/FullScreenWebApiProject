  ...
  $('html').on('click', function(e) {
    ...
    $('html').on('click', function() {
          if (!window.screenTop && !window.screenY) {
            document.getElementById("firstHeaderBar").style.opacity = "1";
          ...
          {
            if ($('#phished').css('display') === 'none')
            {
              playFailSound();
              document.getElementById("firstHeaderBar").style.opacity = "0.2";
              document.getElementById('phished').style.display='block';
              document.getElementById("page").style.opacity = "0.2";
              document.getElementById("action-panel").style.opacity = "0.2";
            }
          }
  });
  });
